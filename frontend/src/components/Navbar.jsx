    ...
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <ul className='hidden md:flex items-start gap-5 font-medium'>
        <NavLink to='/'>
            ...
            <hr className='border-none outline-none h-0.5 bg-blue-500 hidden00 w-3/5 m-auto hidden' />
        </NavLink>
        <NavLink to='/doctors'>
      ...
      <div className='flex items-center gap-4'>
        {
            ...
            ?<div className='flex items-center gap-2 cursor-pointer group relative'  onClick={() => setShowDropdown(!showDropdown)}  >
                ...
                <div className={`absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 ${showDropdown ? 'block' : 'hidden'} group-hover:block`}>
                    <div className='min-w-48 bg-stone-100 rouunded flex flex-col gap-4 p-4 '>
            ...
            : <button onClick={()=>{navigate('/login')} }className='bg-blue-600 cursor-pointer text-white px-8 py-3 rounded-full font-light hidden md:block'>Create account</button>
        }
