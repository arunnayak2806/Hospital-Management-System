...
const Appointment = () => {
  ...
  const bookAppointment = async () =>{
    ...
    try {
      ...
      let month = date.getMonth()+1 // suppose month is january it will return 0+1 >>1
  ...
  return docInfo && (
    <div >
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointment} className='bg-indigo-600 text-white text-sm font-light px-14 py-3 rounded-full my-6'>Book an appointment</button>
      </div>
